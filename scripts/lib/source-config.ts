...
export const SOURCE_CONFIGS: SourceConfig[] = [
  { id: "reuters", displayName: "Reuters", sourceGroup: "global_media", fetchMode: "listing", priority: 100, isActive: true },
  { id: "bloomberg", displayName: "Bloomberg", sourceGroup: "global_media", fetchMode: "listing", priority: 95, isActive: true },
  { id: "ft", displayName: "Financial Times", sourceGroup: "global_media", fetchMode: "listing", priority: 92, isActive: true },
  { id: "wsj", displayName: "WSJ", sourceGroup: "global_media", fetchMode: "listing", priority: 90, isActive: true },
  { id: "wallstreetcn", displayName: "华尔街见闻", sourceGroup: "china_media", fetchMode: "rss", priority: 82, isActive: true },
  { id: "scmp", displayName: "SCMP", sourceGroup: "hk_media", fetchMode: "listing", priority: 80, isActive: true },
